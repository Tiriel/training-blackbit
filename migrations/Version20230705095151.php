 ...
 */
final class Version20230705095151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , plot CLOB NOT NULL, price INTEGER DEFAULT NULL, rated VARCHAR(255) DEFAULT NULL, imdb_id VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_1D5EF26FB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        , plot CLOB NOT NULL, price INTEGER DEFAULT NULL, rated VARCHAR(255) DEFAULT NULL, imdb_id VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO movie (id, title, poster, country, released_at, plot, price, rated, imdb_id) SELECT id, title, poster, country, released_at, plot, price, rated, imdb_id FROM __temp__movie');
        $this->addSql('DROP TABLE __temp__movie');
